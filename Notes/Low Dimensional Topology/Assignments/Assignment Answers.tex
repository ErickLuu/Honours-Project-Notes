...
\paragraph{$1 \Rightarrow 2$} Take the union of the families of curves the homotopy traces out. Then this will form a disk and $\gamma$ is on the boundary of the disk. 

\subsection{4}
\paragraph{$1 \Rightarrow 2$} Firstly, $\gamma$ is homeomorphic thus homotopic to $S^1 \times {1}$ as it is homeomorphic to this loop through $h$. Then $\gamma$ is homotopic to $S^1 \times {0}$ through the homotopy $S^1 \times {t}$.



\subsection{5}
There is an ambient isotopy $h : \partial V \times I \rightarrow \partial V$ such that $h(\alpha, 0) = h(\alpha, 1) = \beta$, as all meridians on the torus are ambient isotopic. Then all meridians bound a disk, and by the Sphere lemma, $h$ has an extension on this disk, so $h : \partial V \cup D^2 \times I \rightarrow \partial V$ is an ambient isotopy. Then if we cut $V$ along $D$, then this is a closed ball, so $h$ has an extension from the boundary of the ball to the whole ball by the sphere lemma. Then this extension is an ambient isotopy $H$ such that $H(\alpha, 0) = \alpha$ and $H(\alpha, 1) = \beta$. 
