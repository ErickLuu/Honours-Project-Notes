...
\newcommand{\RIIIbottom}{\includegraphics[angle = 180]{Figures/Crossings/R3top.png}}
...
\begin{align*}
    P(\RIIItop) &= P(\RIIIbottom)\\
    &= f(A)P(\includegraphics{Figures/Crossings/R3Ares.png}) + g(A)P(\includegraphics{Figures/Crossings/R3Bres.png})\\
    &= f(A)P(\includegraphics[angle = 180]{Figures/Crossings/R3Ares.png}) + g(A)P(\includegraphics[angle = 180]{Figures/Crossings/R3Bres.png})\\
    &=P(\RIIIbottom)
\end{align*}
