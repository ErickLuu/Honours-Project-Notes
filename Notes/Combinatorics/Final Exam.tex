...
\end{equation} 
But notice that $(2^n)^3$ bounds the product of each of these terms as when taking logs of both equations, we have a $3n$ term out but the largest term out is a $\log n n^2/3$. Therefore, we have that the term above is of $o(S)$. Therefore, the tails is negligible. 
\section{Question 8}
