...
$R_k = (n + \sqrt{n} + n^{3/10})/(n + 2 n^{8/10} + n^{9/100})$, which approaches 1. Therefore, we have that the bound in this section $k = [\sqrt{n} + M, n]$ is bounded above by $n \times (n + k)!/n! (k!)^2$ which is of $o(S)$, where s is the sum. 
