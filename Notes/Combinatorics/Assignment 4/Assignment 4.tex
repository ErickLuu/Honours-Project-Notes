...
\begin{equation}
	\sum_{y = \lfloor - M \rfloor }^{ \lceil M \rceil}  \frac{(n + \sqrt{n} + y)!}{n!(\sqrt{n} + y)!^2}.
\end{equation}
Now we use Stirling's approximation.

\begin{align*}
	(n + \sqrt{n} + y)! &= \left(\frac{n + \sqrt{n} + y}{e}\right)^{n + \sqrt n + y} \sqrt{2 \pi (n + \sqrt{n} + y)}\\
	n! &= \left(\frac{n}{e}\right)^n \sqrt{2 \pi n}\\
	(\sqrt{n} + y)! &= \left(\frac{\sqrt{n} + y}{e}\right)^{\sqrt{n} + y} \sqrt{(2 \pi)(\sqrt{n} + y)}
\end{align*}
Substituting this into the equation above, we get:

\begin{align*}
	&\sum_{y = \lfloor - M \rfloor }^{ \lceil M \rceil}  \frac{ \left(\frac{n + \sqrt{n} + y}{e}\right)^{n + \sqrt n + y} \sqrt{2 \pi (n + \sqrt{n} + y)}}{\left(\frac{n}{e}\right)^n \sqrt{2 \pi n}\left(\left(\frac{\sqrt{n} + y}{e}\right)^{\sqrt{n} + y} \sqrt{(2 \pi)(\sqrt{n} + y)}\right)^2}\\
	&= \sum_{y = \lfloor - M \rfloor }^{ \lceil M \rceil} \frac{1}{2 \pi e^{\sqrt{n} + y}} 
	\frac{
	\left(n + \sqrt{n} + y\right)^{n + \sqrt{n} + y}
	\sqrt{n + \sqrt{n} + y}
	}{
	n^n \sqrt{n} 
	\left(\sqrt{n} + y\right)^{\sqrt{n} + y}
	(\sqrt{n} + y)
	}\\
	&= \sum_{y = \lfloor - M \rfloor }^{ \lceil M \rceil} \frac{1}{2 \pi e^{\sqrt{n} + y}} 
\end{align*}
Now we use the approximation of $(n + \sqrt{n} + y)^{n + \sqrt{n} + y} = $
\section{2}
Let
