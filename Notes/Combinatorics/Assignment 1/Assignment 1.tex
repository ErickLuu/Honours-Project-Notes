...
\end{align*}
\subsection{Part b}
We have that $|S_{2, n}| = n! \sum_{i = 0}^n \frac{(-1)^i}{i!} $, which is the number of derangements on $[n]$. We also have that $|S_{2, n}| = \frac{2}{n} \binom{n}{2} |R_{2, n}| = (n-1) |R_{2,n}|$. We have that $|R_{2, n}|$ is the number of derangements where  $\sigma(1) = 2$. 
\section{Question 3}
...
\end{equation}
with the base case $T_{n, 0} = 1$. We also have an upper bound where ...
\section{Question 4}
\section{Question 5}
