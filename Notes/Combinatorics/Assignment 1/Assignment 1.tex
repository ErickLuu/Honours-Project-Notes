...
Suppose a submatrix has three entries equalling $1$ and zeroes everywhere else. It is counted once in $N_{\geq}(S_0)$, three times in $N_{\geq}(S_1)$, three times in $N_{\geq}(S_2)$, and once in $N_{\geq}(S_2)
\end{document}
