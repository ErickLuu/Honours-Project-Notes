...
Finally consider a sequence of $(B_n)_n \subset \mathbb{F}$ which is pairwise disjoint, such that $P(B_i) \geq P(B_{i + 1})$ for all $i$. Fix $\varepsilon > 0$. Then since $B_i$ is pairwise disjoint then $P()
