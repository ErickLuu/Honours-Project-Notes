...
Finally consider a sequence of $(B_n)_n$ which is pairwise disjoint. Fix $\varepsilon > 0$. Consider a sequence $(A_n)_n \in \mathcal{A}$ such that $P(A_i \triangle B_i) < \varepsilon/2^i. 
