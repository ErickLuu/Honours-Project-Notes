...
\section{Definitions}
Suppose $G$ is a finite group and $X$ is a r.v. on $G$. $P$ is a probability distribution function where $P(g) = \text{Prob}[X = g]$ and $\sum_{g\in G} P(g) = 1$.
...
\begin{proof}
	...
	\end{align*}
\end{proof}
Thus this is a probability distribution. Proof of support is trivial.
...
\begin{theorem}[Plancherel]
	...
	Let $G$ be a finite abelian group and let $a, b \in \mathbb{C}(G)$. Then $\langle a, b \rangle = \frac{1}{|G|} \langle \widehat{a}, \widehat{b} \rangle$. 
\end{theorem}
\begin{proof}
