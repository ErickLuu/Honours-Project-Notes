...
We can classify all surfaces as the connected sums of tori or projective planes. We say that a surface $\Sigma$ is orientable if it is a connected sum of tori, and $\Sigma$ is non-orientable if it is a connected sum of projective planes. Note that if $P$ is a projective 

We say that the genus 
