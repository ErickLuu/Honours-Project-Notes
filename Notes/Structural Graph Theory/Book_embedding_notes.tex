...
\begin{itemize}
	...
	\item \cref{sec:BoundedPagenumber} formally defines a book-embedding and pagenumber of a graph $G$, and describes some cases where the pagenumber is completely defined for a family of graphs $\mathcal{G}$. A
	...
	\item \cref{sec:Kt_Minor_Free} describes the Graph Minor Structure Theorem, but we do not discuss the proof. We also discuss its relationship to the Graph Minor theorem.
