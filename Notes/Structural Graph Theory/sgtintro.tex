...
\end{itemize}
Of course, these properties have to be meaningful. While computation of many of these properties is difficult, they are necessary to understand what is going on. 
Some important properties in structural graph theory are, in no particular order:
...
\begin{itemize}
	...
	\item Genus
\end{itemize}
Many of these concepts are highly connected to topological graph theory, which deals with embedding graphs on some space. Proofs in structural graph theory tend to not think about the underlying space, like in topological graph theory. Indeed, many concepts in structural graph theory preserve some topology of the graph, in a loose way. 
