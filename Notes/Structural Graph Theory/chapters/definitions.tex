...
\begin{proof}
	...
	\begin{figure}[h]
		...
		\centering
		\input{chapters/figures/k8-withcolouring}
...
\begin{example}\label{ex:treewidth_forest}
	...
	\begin{proof}
		...
		\begin{figure}[h]
			\centering
			\input{chapters/figures/treewidth-tree}
			\input{chapters/figures/treewidth-tree-treedecomp}
...
\end{proof}
	\begin{figure}[h]
		\centering
		\input{chapters/figures/caterpillar-graph}
		\caption{A caterpillar graph. Notice that the path $a - b - d - g - i$ is the central path.}
		\label{fig:caterpillar}
	\end{figure}
\todo{make this caterpillar graph look good and add circles to show the path decomposition}
