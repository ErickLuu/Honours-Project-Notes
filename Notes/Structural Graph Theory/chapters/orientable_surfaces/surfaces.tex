...
\section{Surfaces}
In this section, we discuss surfaces. We also introduce some machinery to deal with vortices on surfaces. Surfaces are an ingredient to the Graph Minor Structure Theorem and having a way to bound the number of pages of graphs embedded on a surface will be very useful. 
