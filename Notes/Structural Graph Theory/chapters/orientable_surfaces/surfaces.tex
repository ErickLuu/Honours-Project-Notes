...
\section{Surfaces}
In this section, we discuss surfaces and a method for dealing with vortices on surfaces. Surfaces are an ingredient to the Graph Minor Structure Theorem and having a method to bound the number of pages of graphs embedded on a surface will be very useful. 
