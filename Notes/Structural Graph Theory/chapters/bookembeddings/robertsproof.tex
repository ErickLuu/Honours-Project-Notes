...
\begin{proof}
	Suppose there is a separating triangle. Then there is a separator of size 3. So the planar triangulation is not 4-connected. Suppose a planar triangulation is $3$-connected. As 
\end{proof}
