...
\end{lemma}
\begin{proof}
	Let $G$ be an almost-projective-planar graph, so there are subgraphs $G_0, \ldots, G_p$ where $G_0$ is a projective-planar graph, $G_1, \ldots, G_p$ are vortices on $G_0$ of depth $\leq k$. 
