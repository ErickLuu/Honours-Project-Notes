...
\end{conjecture}
This report lays out the current literature related to this question. We use a result in one of the papers of the Graph Minor Theorem, by \textcite{robertsonGraphMinorsXVI2003}. The result we use is the Graph Minor Structure Theorem, which describes $K_t$-minor free graphs.
