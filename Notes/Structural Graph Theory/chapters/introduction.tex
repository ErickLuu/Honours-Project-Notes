...
\end{conjecture}
In her PhD thesis, \textcite{Blankenship-PhD03} claimed to prove \cref{conj:bded_had_pn}. However, this result has not been published and has not been independently verified. Furthermore, a capstone proof from \textcite{heathPagenumberGenusGraphs1992} was found to be missing crucial parts. \textcite{nakamotoBookEmbeddingProjectiveplanar2015} found that a crucial case was missed by Heath and Istrail. We aim to fill this gap in knowledge. 
