...
\begin{proof}
	Let $G$ be a 4-connected planar graph embedded on some surface. Now we have that $G$ has a Hamiltonian cycle. Now as $G$ is planar, the Hamiltonian cycle splits the surface into an interior region and an exterior region, by the Jordan curve theorem. So every face is inside either the interior or exterior of the Hamilton cycle. But this means that every every face maintains the ordering
