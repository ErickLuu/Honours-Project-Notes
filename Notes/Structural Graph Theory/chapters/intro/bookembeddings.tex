\subsection{Book-Embeddings}\label{sec:Book Embedding}
...
\begin{figure}[h!]\label{fig:book-embedding}
	...
	\caption[Book-embedding of $K_5$ on three pages]{Image by \textcite{eppsteinBookEmbedding2014}. Every edge is embedded on a page, and is given a single colour. }
\end{figure}
