...
\end{theorem}
Equivalently, if $G$ is $K_5$ minor free, then $G$ has a tree-decomposition $\tree$ where $\tree$ has adhesion at most 3, and every torso of $\tree$ is either planar or the Wagner graph. 
\begin{theorem}
