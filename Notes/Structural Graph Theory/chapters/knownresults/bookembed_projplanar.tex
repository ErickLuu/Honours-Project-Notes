...
\end{conjecture}
However, the proof given in their paper is far too vague and is insufficient to prove the theorem. An example of a projective-planar graph is in \cref{fig:projectiveplanar}.
...
\end{figure}
\textcite{nakamotoBookEmbeddingProjectiveplanar2015} also notices this error and proves the following theorem.
