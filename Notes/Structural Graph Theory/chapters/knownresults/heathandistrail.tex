...
\begin{proof}
	...
	Now we have that \(E_N\) has every edge which cannot be added to \(G_P\) without crossing over another edge, and that \(G_P\) is maximal. Then we have that all edges in \(E_N\) satisfy the conditions listed above.
