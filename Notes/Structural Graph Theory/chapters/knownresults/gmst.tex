...
The reason why vortices are important are graphs like in \cref{fig:tenniscourt}. This graph is one where vortices are needed as an essential ingredient and in fact there is a vortex of pathwidth 6 which is glued onto a graph of genus 0. 

\begin{figure}[h]
	\centering
	\includesvg{chapters/figures/tenniscourt}
