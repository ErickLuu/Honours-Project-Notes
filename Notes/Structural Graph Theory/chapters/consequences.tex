...
This does not say that $\pn(H) \leq \pn(G)$ when $H$ is a minor of $G$. We may subdivide a graph $G$ such that every edge has $O(|V(G)|)$ vertices to make $G'$, and we have that $G'$ has pagenumber at most 3. Then $G$ is a minor of $G'$ but $G$ has unbounded pagenumber. \todo{reference this!}
