...
Note that ``genus'' and ``Euler genus'' are two distinct concepts. In many works, ``genus'' refers to the orientable genus. However, in this thesis, genus is a synonym for \underline{Euler genus} unless stated otherwise.
