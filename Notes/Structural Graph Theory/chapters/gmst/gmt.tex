...
The family of graphs that can be embedded on a torus are the toroidal graphs. 17,523 minimal forbidden toroidal minors have been found, with a database maintained by \textcite{myrvoldLargeSetTorus2018}. A complete enumeration of minimal forbidden minors has not been found. 
