...
\end{proof}
To prove the reverse direction, we wish to construct a bramble such that the smallest hitting set is at least $\tw(G) + 1$. As we are taking this over maximal hitting sets, then proving an upper bound. 
\begin{theorem}
