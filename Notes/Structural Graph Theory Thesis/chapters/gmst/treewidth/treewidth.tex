...
This implies that every $K_4$-minor free graph is not $3$-connected, therefore every $K_4$ minor free graph contains a vertex of degree at most 2. The next proof is a proof of \cref{prop:k4-minor}.
