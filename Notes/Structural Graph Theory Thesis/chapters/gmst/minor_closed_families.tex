...
This is a compilation of small $K_t$-minor-free graphs and some important minor-closed families. \cref{tab:kt_minor_free} compiles a list of $K_t$-minor-free graphs and their characterisation. There is no known good characterisation of $K_6$-minor-free graphs. 
...
\begin{table}[h!]
    ...
    Toroidal Graphs              & $\geq 17523$                       & $K_8, K_5 + K_5, K_{3,3} + K_{3,3}$        & \tablefootnote{\textcite{myrvoldLargeSetTorus2018}}           \\
    ...
    Knotlessly Embeddable graphs & $\geq 263$                           & $K_7$, $K_{3,3,1,1}$                                            & \tablefootnote{\textcite{goldbergManyManyMore2014}}\\
    \bottomrule
    \end{tabular*}
