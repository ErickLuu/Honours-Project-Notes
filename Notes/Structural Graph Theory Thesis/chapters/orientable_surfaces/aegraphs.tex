...
\begin{proof}
	...
	Every torso $G \langle B_x \rangle$ has a tree-decomposition where every face is preserved, from \cref{lem:Hamiltonian_preserved_faces}. Then apply \cref{thm:clique_sum_pagenumber_bound} to $((T,r), (B_x)_x)$ to embed $G$ in a book. Let the root bag be the bag that contains the outerface. 
	...
	Now as any face $F$ has a decomposition into cycles and cut-vertices, and as the cut vertices preserve faces, then every face $F$ has at most $12$ monochromatic paths. 
\end{proof}	