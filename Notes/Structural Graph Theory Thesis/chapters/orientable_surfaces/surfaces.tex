...
\begin{corollary}\label{corr:orientable_nonplanar_faces}
	Let \(G\) be a graph embedded on a surface \(\Sigma\) of Euler genus $g$ with a planar-nonplanar decomposition $(G_P, E_N)$ and let \(F\) be a nonplanar face.  Then \(F\) transitions between edges on the boundary of $G_P$ and nonplanar edges at most $4g$ times.
\end{corollary}
