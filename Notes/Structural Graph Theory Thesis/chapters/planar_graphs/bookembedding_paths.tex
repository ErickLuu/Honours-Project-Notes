...
In this section, we find some graph parameter that allows us to bound the number of pages necessary to embed a vortex on a face. The obvious conjecture would be that there is a way to embed a vortex on any face with a bounded number of pages, which is \cref{conj:fsk_be}. We show that \cref{conj:fsk_be} implies \cref{conj:bded_had_pn} in certain cases. We also show \cref{conj:fsk_be} has a counterexample.
...
We finally discuss our final conjecture which implies \cref{conj:bded_had_pn}. 
