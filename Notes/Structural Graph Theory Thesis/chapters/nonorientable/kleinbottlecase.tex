...
\end{theorem} 
This approach cannot be generalised to higher Euler genus graphs, as an enumeration of irreducible triangulations for higher Euler genus surfaces is unknown.
