...
\begin{theorem}\label{thm:proj_planar_graphs_23pages}
	Every graph embedded on the projective plane has a book-embedding with 23 pages. 
\end{theorem}
...
\begin{proof}
    ...
    From \cref{thm:planar_graph__be_mono_paths}, there exists an 11-page embedding $(<_1, \sigma_1)$ of $D_1$ which preserves the cycle $P \cup B_1$. Similarly, there exists an 11-page embedding $(<_2, \sigma_2)$ of $D_2$ which preserves the cycle $P \cup B_2$.
