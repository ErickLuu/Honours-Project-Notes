...
\begin{abstract}
	...
	The major contribution of this thesis is a partial result for when the Graph Minor Structure Theorem is restricted to certain graphs embedded on orientable surfaces or the projective plane. Then the graph can be embedded on a bounded number of pages.
