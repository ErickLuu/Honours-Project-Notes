...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \cref{sec:pagenumber_bounded_genus} proves that every graph with bounded genus have bounded pagenumber.
	\end{itemize}
\end{itemize}
\input{chapters/knownresults/gmst}
\input{chapters/knownresults/robertsproof}
\input{chapters/knownresults/ganleyheathdujwood}
